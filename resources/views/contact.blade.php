    ...
    <section class="bg-white dark:bg-gray-900">
        <div class="container px-6 py-12 mx-auto">
            <div class="text-center ">
                ...
                <h1 class="mt-2 text-2xl font-semibold text-gray-800 md:text-3xl dark:text-white">We’d love to hear from a Furparent like Us</h1>
    
                <p class="mt-3 text-gray-500 dark:text-gray-400">Chat to our friendly team.</p>
            </div>
    
            <img class="object-cover w-full h-64 mt-10 rounded-lg lg:h-96" src="/img/contact.png" alt="">
            ...
            <div class="grid grid-cols-1 gap-12 mt-10 lg:grid-cols-3 sm:grid-cols-2 ">
                <div class="p-4 rounded-lg bg-blue-50 md:p-6 dark:bg-gray-800">
                    ...
                    <h2 class="mt-4 text-base font-medium text-gray-800 dark:text-white">Chat to Team</h2>
                    <p class="mt-2 text-sm text-gray-500 dark:text-gray-400">Speak to our team.</p>
                    <p class="mt-2 text-sm text-blue-500 dark:text-blue-400">furcom@gmail.com</p>
                </div>
                ...
                <div class="p-4 rounded-lg bg-blue-50 md:p-6 dark:bg-gray-800">
                    ...
                    <p class="mt-2 text-sm text-blue-500 dark:text-blue-400">PhirstPark Tanza, Brgy. Tanauan, Tanza</p>
                </div>
                ...
                <div class="p-4 rounded-lg bg-blue-50 md:p-6 dark:bg-gray-800">
                    ...
                    <p class="mt-2 text-sm text-blue-500 dark:text-blue-400">+639 182 1827</p>
                </div>
            </div>
        </div>
    </section>
