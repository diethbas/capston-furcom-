...
@section('content')
    ...
    @endif
    <!-- Sign in -->
    <section class="bg-white dark:bg-gray-900 bg-gradient-to-tr from-gray-900 via-gray-900 to-purple-900">
        <div class="container flex items-center justify-center min-h-screen px-6 mx-auto">
            <form id="loginForm" class="w-full max-w-md text-center" method="POST">
                ...
                <h1 class="mt-3 text-2xl font-semibold text-gray-800 capitalize sm:text-3xl dark:text-white">Welcome Back</h1>
                ...
                @if(session('error'))
                <div id="formError" class="flex items-center p-4 mt-4 mb-4 text-sm text-red-800 rounded-lg bg-red-50 dark:bg-gray-800 dark:text-red-400" role="alert">
