...
<!-- Hero Section -->
    <section class="bg-gradient-to-tr from-gray-900 via-gray-900 to-purple-900">
        <div class="container px-6 py-16 mx-auto text-center">
            <div class="max-w-lg mx-auto">
                <h1 class="text-3xl font-semibold text-white lg:text-4xl">Build Stronger Bonds with Furparent Using Our Pawsome Community</h1>
                <p class="mt-6 text-gray-300">Join a community where pet parents connect, share, and support each other in their journey of pet parenting.</p><br>
    ...
    <section class="pb-12  bg-gray-900">
        <div class="container px-4 py-8 mx-auto">
            <div class="mt-4 md:flex md:items-center md:justify-between">
                <div>
                    <h1 class="text-xl font-semibold text-white capitalize lg:text-2xl">What Furparents are saying</h1>
            ...
            <section class="grid grid-cols-1 gap-6 mt-6 xl:mt-10 lg:grid-cols-2 xl:grid-cols-3">
                <div class="p-6 border border-gray-700 rounded-lg bg-gray-900">
                    <p class="leading-loose text-sm text-gray-300">“Natulungan talga ako ng Furcom, nung gumawa ako ng sariling profile para sa aking furbaby naging masaya ako na makilala ang iba pang mga pet owners at makipagpalitan ng mga stories about sa aming buhay.”</p>
                    <div class="flex items-center mt-6 -mx-2">
                        <img class="object-cover mx-2 rounded-full w-10 shrink-0 h-10 ring-4 ring-gray-700" src="https://images.unsplash.com/photo-1570295999919-56ceb5ecca61?ixlib=rb-1.2.1&auto=format&fit=crop&w=880&q=80" alt="Testimonial 1" />
                        <div class="mx-2">
                            <h1 class="text-sm font-semibold text-white">Robert</h1>
                            <span class="text-xs text-gray-400">PhirstPark Tanza Homeowner</span>
                        </div>
                    </div>
                </div>

                <div class="p-6 bg-blue-600 border border-transparent rounded-lg">
                ...
                <div class="p-6 border border-gray-700 rounded-lg bg-gray-900">
                    <p class="leading-loose text-sm text-gray-300">“Ang profile para sa aking furbaby sa website ay talagang enjoy. Nagbibigay ito ng pagkakataon na ipakita ang kanyang personalidad at kumonekta sa iba pang mga pet owners na may katulad na hilig at interes.”</p>
                    <div class="flex items-center mt-6 -mx-2">
                        <img class="object-cover mx-2 rounded-full w-10 shrink-0 h-10 ring-4 ring-gray-700" src="https://images.unsplash.com/photo-1488508872907-592763824245?ixlib=rb-1.2.1&auto=format&fit=crop&w=1470&q=80" alt="Testimonial 3" />
                        <div class="mx-2">
                            <h1 class="text-sm font-semibold text-white">Neil</h1>
    ...
    <section class="py-8 bg-gray-900">
        <div class="container px-6 py-10 mx-auto">
            <h1 class="text-2xl font-semibold text-center text-white capitalize lg:text-3xl">explore <br> what we can <span class="text-blue-500">Offer</span></h1>
            <div class="grid grid-cols-1 gap-8 mt-8 xl:mt-12 xl:gap-16 md:grid-cols-2 xl:grid-cols-3">
                <div class="flex flex-col items-center p-6 space-y-3 text-center bg-gray-800 rounded-xl">
                    <span class="inline-block p-3 text-white bg-blue-500 rounded-full">
                        <svg xmlns="http://www.w3.org/2000/svg" class="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 12c2.21 0 4-1.79 4-4s-1.79-4-4-4-4 1.79-4 4 1.79 4 4 4zm0 2c-2.67 0-8 1.34-8 4v2h16v-2c0-2.66-5.33-4-8-4z" />
                        </svg>
                    </span>
                    <h1 class="text-xl font-semibold text-white capitalize">Furparents Profile</h1>
                    <p class="text-gray-300">Furparents can create personalized profiles for their pets, providing detailed information to connect with other pet lovers and enhance their experience.</p>
                </div>
                <div class="flex flex-col items-center p-6 space-y-3 text-center bg-gray-800 rounded-xl">
                    <span class="inline-block p-3 text-white bg-blue-500 rounded-full">
                        <svg xmlns="http://www.w3.org/2000/svg" class="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    ...
                    <h1 class="text-xl font-semibold text-white capitalize">QR Codes</h1>
                    <p class="text-gray-300">The website offers a feature to generate unique QR codes for pets, allowing easy access to essential pet information when scanned by others.</p>
                </div>
                <div class="flex flex-col items-center p-6 space-y-3 text-center bg-gray-800 rounded-xl">
                    <span class="inline-block p-3 text-white bg-blue-500 rounded-full">
                        <svg xmlns="http://www.w3.org/2000/svg" class="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    ...
                    <h1 class="text-xl font-semibold text-white capitalize">Connect</h1>
                    <p class="text-gray-300">Users can create detailed profiles for their furbabies, showcasing important information and connecting with other pet enthusiasts.</p>
                </div>
            </div>
        </div>
    </section>
                ...
                <div class="p-6 space-y-4">
                    ...
                    <form class="max-w-md mx-auto">
                        ...
                        <div class="relative z-0 w-full mb-5 group">
                            <input type="text" name="floating_contact" id="floating_contact" class="block py-2.5 px-0 w-full text-sm  bg-transparent border-0 border-b-2  appearance-none text-white border-gray-600 focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" " required />
                            <label for="floating_contact" class="peer-focus:font-medium absolute text-sm  text-gray-400 duration-300 transform -translate-y-6 scale-75 top-3 -z-10 origin-[0] peer-focus:left-0 peer-focus:text-blue-600 peer-focus:text-blue-500 peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6">Your Contact Information (Phone or Email)</label>
                        </div>

                        <!-- Subject -->
                        <div class="relative z-0 w-full mb-5 group">
                            <input type="text" name="floating_subject" id="floating_subject" class="block py-2.5 px-0 w-full text-sm  bg-transparent border-0 border-b-2  appearance-none text-white border-gray-600 focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" " required />
                            <label for="floating_subject" class="peer-focus:font-medium absolute text-sm  text-gray-400 duration-300 transform -translate-y-6 scale-75 top-3 -z-10 origin-[0] peer-focus:left-0 peer-focus:text-blue-600 peer-focus:text-blue-500 peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6">Subject</label>
                        </div>

                        <!-- Message -->
                        <div class="relative z-0 w-full mb-5 group">
                            <textarea name="floating_message" id="floating_message" rows="4" class="block py-2.5 px-0 w-full text-sm  bg-transparent border-0 border-b-2  appearance-none text-white border-gray-600 focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" " required></textarea>
                            <label for="floating_message" class="peer-focus:font-medium absolute text-sm  text-gray-400 duration-300 transform -translate-y-6 scale-75 top-3 -z-10 origin-[0] peer-focus:left-0 peer-focus:text-blue-600 peer-focus:text-blue-500 peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6">Message</label>
                        </div>

                        <button type="submit" class="text-white   focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center bg-blue-600 hover:bg-blue-700 focus:ring-blue-800">Send</button>
                    </form>
                </div>
            </div>
        </div>
