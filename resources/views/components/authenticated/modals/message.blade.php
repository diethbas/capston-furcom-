        ...
        function getMessageTemplate(img, message, fullname, timestamp) {
            ...
            return `
                <div class="flex items-start mb-4">
                    ...
                    <div>
                        <p class="text-sm text-gray-600 dark:text-gray-300"><strong class="text-gray-800 dark:text-white">${fullname}:</strong> ${message}</p>
...
<div id="messageModal" tabindex="-1" class="hidden fixed inset-0 z-50 flex justify-center md:justify-end md:items-end bg-black bg-opacity-50">
    <div class="relative w-full md:max-w-xs bg-white bg-opacity-90 rounded-lg shadow dark:bg-gray-800 md:mr-10 md:mb-10 h-96 flex flex-col">
        <div class="p-4 border-b dark:border-gray-600">
            <h3 class="text-lg font-semibold text-gray-900 dark:text-white">Message to <span id="sendMessage-ToName">#test</span></h3>
        ...
        <div class="p-4 border-t dark:border-gray-600">
            <div class="relative">
                <input id="sendMessage-content" type="text" class="block w-full py-2 px-4 text-gray-900 bg-gray-100 rounded-lg focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:text-white dark:placeholder-gray-400" placeholder="Type your message...">
