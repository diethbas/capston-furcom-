...
<nav class="sticky top-0 py-0.5 border-b border-gray-200 bg-gray-900 shadow-[0_1px_2px_rgba(0,0,0,0.05)] z-50">
    <div class="max-w-screen-xl flex items-center justify-between mx-auto p-1.5">
        ...
        <div class="md:hidden relative">
            <button id="mobileSearchButton" data-dropdown-toggle="dropdownSearch" class="text-gray-400  hover:bg-gray-700 p-2 rounded-full">
        ...
        <div class="flex items-center space-x-3">
            ...
            <div class="relative">
                <button id="chatDropdownButton" data-dropdown-toggle="chatDropdown" class="flex items-center justify-center p-1 w-8 h-8 bg-gray-800 rounded-full   focus:outline-none text-gray-400 hover:bg-gray-700">
            ...
            <div class="relative">
                <button id="notificationDropdownButton" data-dropdown-toggle="notificationDropdown" class="flex items-center justify-center p-1 w-8 h-8 bg-gray-800 rounded-full focus:outline-none text-gray-400 hover:bg-gray-700">
                    ...
                    <div class="p-4 text-sm  text-gray-300">
                        ...
                        <ul class="mt-2 space-y-2">
                            <li class="flex items-start">
                                ...
                                <p class="ml-2  text-gray-400 truncate max-w-xs">Mark Aragon added you!</p>
                            </li>                                
                        </ul>
                    </div>
                </div>
