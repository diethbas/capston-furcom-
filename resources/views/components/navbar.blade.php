...
<nav class="sticky top-0 border-b border-gray-200  bg-gray-900 shadow-[0_1px_2px_rgba(255,255,255,0.1)] z-50">
    <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-1.5">
        <div class="flex items-center justify-between w-full md:w-auto">
            ...
            class="inline-flex items-center justify-center p-1 w-10 h-10 text-sm rounded-lg md:hidden focus:outline-none focus:ring-2 text-white hover:bg-gray-700 focus:ring-gray-600"
            ...
            <!-- Logo -->
            <a href="{{url('/')}}" class="mr-3 flex items-center space-x-3 rtl:space-x-reverse">
